...
const ChatPage = () => {
  ...
  const handleSendMessage = () => {
    ...
    setChats(chats.map(chat => 
      chat.id === activeChat.id 
        ? { ...chat, lastMessage: message, messages: [...chat.messages, newMessage] }
        : chat
    ));
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-gray-50 to-gray-100 mt-3">
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-4xl my-4 bg-white rounded-lg shadow-md">
              ...
              {activeChat ? (
                ...
                <div className="flex-1 flex items-center justify-center bg-gray-100">
                  <div className="text-center p-6">
                    ...
                    <p className="text-gray-700">Выберите диалог из списка или начните новый</p>
                  </div>
                </div>
              )}
            </div>
